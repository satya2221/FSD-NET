...
{
    public partial class EditOnDeleteNoActionInHistory : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Nik = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
                    ...
                    CommisionPct = table.Column<float>(type: "real", nullable: true),
                    ManagerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Histories", x => new { x.EmployeeId, x.StartDate });
                    table.ForeignKey(
                        name: "FK_Histories_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRoles_Users_EmployeeId",
                        column: x => x.EmployeeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Histories_DepartmentId",
                table: "Histories",
                column: "DepartmentId");
